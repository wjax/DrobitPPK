...
{
	/// <summary>
	/// A value converter which contains a list of IValueConverters and BeginInvokes their Convert or ConvertBack methods
	/// in the order that they exist in the list.  The output of one converter is piped into the next converter
	/// allowing for modular value converters to be chained together.  If the ConvertBack method is BeginInvoked, the
