    ...
    internal partial class DownloadUpdateDialog : MaterialForm
    {
        ...
        private void WebClientOnDownloadFileCompleted(object sender, AsyncCompletedEventArgs asyncCompletedEventArgs)
        {
            ...
            if (extension.Equals(".zip", StringComparison.OrdinalIgnoreCase))
            {
                ...
                string installerDLLPath = Path.Combine(Path.GetDirectoryName(tempPath), "DotNetZip.dll");
                File.WriteAllBytes(installerDLLPath, Resources.DotNetZip);
                string installerMaterialDLLPath = Path.Combine(Path.GetDirectoryName(tempPath), "MaterialSkin.dll");
                File.WriteAllBytes(installerMaterialDLLPath, Resources.MaterialSkin);
                StringBuilder arguments = new StringBuilder();
                arguments.Append('"').Append(tempPath).Append('"').Append(" ");
                arguments.Append('"').Append(Process.GetCurrentProcess().MainModule.FileName).Append('"');
                //string arguments = "C:\\Users\\Jesus\\AppData\\Local\\Temp\\CCLast.zip D:\\Development\\dotNET\\DrobitDesktopSW\\DrobitControlCenter\\ControlCenter\\bin\\Debug\\ControlCenter.exe";
